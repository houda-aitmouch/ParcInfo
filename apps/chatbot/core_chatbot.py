    ...
    def __init__(self):
        try:
            ...
            if SentenceTransformer is not None:
                ...
                logger.warning("SentenceTransformers not available, NLP features disabled")
                self.embedding_model = None
                self.nlp_available = False
...
"""
    ...
    def _handle_delivery_overview(self, entities: Dict) -> str:
        ...
        try:
            ...
            # Harmoniser la définition du retard: prévu < aujourd'hui et (pas d'effectif ou effectif > prévu)
            retard = 0
