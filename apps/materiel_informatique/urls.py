...
app_name = 'materiel_informatique'

urlpatterns = [
    # URLs existantes
    path('', views.liste_materiels, name='liste_materiels'),
    path('ajouter/', views.ajouter_materiel, name='ajouter_materiel'),
    path('api/lignes_commande_par_commande/<int:commande_id>/', views.lignes_commande_par_commande, name='lignes_commande_par_commande'),
    ...
    path('gestionnaire-info/ajouter/', views.ajouter_materiel_gestionnaire_info, name='ajouter_materiel_gestionnaire_info'),
    path('gestionnaire-info/modifier/<int:pk>/', views.modifier_materiel_gestionnaire_info, name='modifier_materiel_gestionnaire_info'),
    path('gestionnaire-info/supprimer/<int:pk>/', views.confirmer_suppression_gestionnaire_info, name='confirmer_suppression_gestionnaire_info'),
