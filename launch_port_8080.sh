...
# Script pour lancer ParcInfo sur le port 8080
# ParcInfo - Serveur HTTP sur port 8080

echo "🚀 LANCEMENT DE PARCINFO SUR PORT 8080"
echo "======================================="
echo "✅ Environnement : rag_env"
echo "✅ Serveur : Port 8080 (HTTP simple)"
...
# Lancer Django sur le port 8080
echo "🚀 Lancement de Django sur le port 8080..."
echo "💡 Le serveur sera accessible sur : http://127.0.0.1:8080/"
